...
- Read Markdown with tables, code blocks, local images, and foldable headings.
- View PDFs and images; search and copy PDF text.
- Browse folders and search saved files across a workspace.
- Use the built-in PowerShell terminal with adjustable width.
- Browse large files and edit individual regions.
